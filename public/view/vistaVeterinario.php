            ...
            <div class="flex items-center justify-between mb-6 text-white">
                <div class="flex items-center space-x-5">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-300 font-medium">Veterinario</p>
                    </div>
                </div>
                ...
                <div id="dropdownMenu"
                    ...
                    <ul class="flex flex-col text-left">
                        <li>
                            <a href="/ganaderia/public/view/gestionSalud.php?finca=<?php echo $_SESSION["finca"]?>&id_usuario=<?php echo $_SESSION["id_usuario"]?>"
