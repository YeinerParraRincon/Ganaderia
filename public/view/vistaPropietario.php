...
<head>
    ...
    <title>Panel del Ganadero</title>
    ...
    <div class="flex flex-col items-center justify-center min-h-screen px-4">
        <div class="bg-gray-800 bg-opacity-60 backdrop-blur-md rounded-2xl shadow-2xl p-8 w-full max-w-5xl">
            ...
            <div class="flex items-center justify-between mb-6 text-white">
                ...
                <div id="dropdownMenu"
                    ...
                    <ul class="flex flex-col text-left">
                        ...
                        <li>
                            <a href="../view/gestionAnimales.php?finca=<?php echo urldecode($_SESSION["finca"]) ?>&id_usuario=<?php echo $_SESSION["id_usuario"] ?>"
                                class="block px-5 py-3 hover:bg-yellow-600 transition">
            ...
            <header class="text-center mb-10">
                <h1 class="text-4xl font-extrabold text-yellow-400 drop-shadow-lg">🐄 Panel del Ganadero</h1>
                <h2 class="text-xl text-yellow-300 mt-2">
                    Bienvenido a la Finca <span class="font-semibold"><?php echo $_SESSION["finca"] ?></span>
                </h2>
            </header>
